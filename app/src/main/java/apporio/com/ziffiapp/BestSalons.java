...
public class BestSalons extends AppCompatActivity {
LinearLayout layou_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_best_salons);
        ...
        layou_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BestSalons.this,Navigation_Activity.class);
...
//list set
        ...
        listView_offers= (ListView) findViewById(R.id.list_offers);
        ListView_Offers_Adapter listView_offers_adapter=new ListView_Offers_Adapter(this,name_type,name_offer,icon);
